...
# Read the data
data <- read.csv("dataexchanges/data_USD_MXN.csv", header = TRUE)
...
write.csv(forecast$mean, file = "data/forecasted_valuesUSD_MXN.csv")
daforcasted <- read.csv("data/forecasted_valuesUSD_MXN.csv", header = TRUE)
print(daforcasted[,2])

# Read the actual data
daActuel <- read.csv("data/actual_data_USD_MXN.csv", header = TRUE)
print(daActuel)
