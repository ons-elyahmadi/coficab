...
# Read the data
daActuel <- read.csv("data/dataactuelEUR_CNY.csv", header = TRUE)
print(daActuel)
...
# Plot actual values
plot(daActuel_values, type = "l", col = "blue", xlab = "Time", ylab = "Price", main = "Actual EUR to CNY Exchange Rates vs Forecasted Values", ylim = c(6, 8))
