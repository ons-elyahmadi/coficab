...
# Lire les données
data <- read.csv("C:/Users/HP/Downloads/Predicting_Metal_Cost_with_R-master-20240318T152350Z-001/Predicting_Metal_Cost_with_R-master/data/cleanindataAlum.csv", header = TRUE)
head(data)

data <- data[order(data$date), ]
head(data)
##data <- head(data, n = nrow(data) - 9)
# Ajuster le modèle ARIMA avec le meilleur ordre
fit <- Arima(data[,2], order = c(1, 1, 7))
...
write.csv(forecasted_data, file = "C:/Users/HP/Downloads/Predicting_Metal_Cost_with_R-master-20240318T152350Z-001/Predicting_Metal_Cost_with_R-master/data/forecasted_22data_ALUM.csv", row.names = FALSE)
...
if (file.exists("C:/Users/HP/Downloads/Predicting_Metal_Cost_with_R-master-20240318T152350Z-001/Predicting_Metal_Cost_with_R-master/data/forecasted_valuesALUM.csv")) {
      old_forecasted_data <- read.csv("C:/Users/HP/Downloads/Predicting_Metal_Cost_with_R-master-20240318T152350Z-001/Predicting_Metal_Cost_with_R-master/data/forecasted_valuesALUM.csv", header = TRUE)
      ...
      write.csv(combined_forecasted_data, file = "C:/Users/HP/Downloads/Predicting_Metal_Cost_with_R-master-20240318T152350Z-001/Predicting_Metal_Cost_with_R-master/data/forecasted_valuesALUM.csv", row.names = FALSE)
} else {
      # Si le fichier n'existe pas, enregistrer les nouvelles données
      write.csv(forecasted_data, file = "C:/Users/HP/Downloads/Predicting_Metal_Cost_with_R-master-20240318T152350Z-001/Predicting_Metal_Cost_with_R-master/data/forecasted_valuesALUM.csv", row.names = FALSE)
}

# Lire les données prévisionnelles combinées
forecasted_data <- read.csv("C:/Users/HP/Downloads/Predicting_Metal_Cost_with_R-master-20240318T152350Z-001/Predicting_Metal_Cost_with_R-master/data/forecasted_valuesALUM.csv", header = TRUE)
print(forecasted_data)
...
write.csv(combined_data, file = "C:/Users/HP/Downloads/Predicting_Metal_Cost_with_R-master-20240318T152350Z-001/Predicting_Metal_Cost_with_R-master/data/last_real_and_forecasted_values_ALUM.csv", row.names = FALSE)
print(combined_data)
...
write.csv(metrics_data, file = "C:/Users/HP/Downloads/Predicting_Metal_Cost_with_R-master-20240318T152350Z-001/Predicting_Metal_Cost_with_R-master/data/metrics_ALUM.csv", row.names = FALSE)
